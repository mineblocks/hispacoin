...
unlocked to sign the Hispacoin-Qt.app bundle.
...
allowing somebody to distribute a Hispacoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the hispacoin-qt.exe file inside the installer had not been tampered with.
